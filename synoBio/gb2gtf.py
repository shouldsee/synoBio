...
def gb2gtf( source='gb2gtf',
           allowedTypes=set(['gene','CDS','tRNA','tmRNA','rRNA','ncRNA']) ):
  """
  """
  handle = sys.stdin
...
parser.add_argument('source', help='genbank input file')
...
# pymisca.bio.read_gtf('ref/VACV-WR-AY243312-1/AY243312.1.gtf')[0].features